...
namespace Oculus.Avatar2.Experimental
{
    ...
    public class OvrAvatarAnimationBehavior : OvrAvatarBaseBehavior
    {
        ...
        private static BehaviorSystem.EventController<bool>? _enableLeftAnkleOverrideEvent;

        private const string LEFT_ANKLE_OVERRIDE_BLEND_FACTOR_EVENT_NAME = "avatarSDK_leftAnkleOverrideBlendFactor";
        private static BehaviorSystem.EventController<float>? _leftAnkleOverrideBlendFactorEvent;

        private const string LEFT_ANKLE_POSITION_OVERRIDE_EVENT_NAME = "avatarSDK_leftAnklePositionOverride";
        private static BehaviorSystem.EventController<Avatar2.CAPI.ovrAvatar2Vector3f>? _leftAnklePositionOverrideEvent;

        private const string LEFT_ANKLE_ROTATION_OVERRIDE_EVENT_NAME = "avatarSDK_leftAnkleRotationOverride";
        private static BehaviorSystem.EventController<Avatar2.CAPI.ovrAvatar2Quatf>? _leftAnkleRotationOverrideEvent;

        private const string ENABLE_RIGHT_ANKLE_OVERRIDE_EVENT_NAME = "avatarSDK_enableRightAnkleOverride";
        private static BehaviorSystem.EventController<bool>? _enableRightAnkleOverrideEvent;

        private const string RIGHT_ANKLE_OVERRIDE_BLEND_FACTOR_EVENT_NAME = "avatarSDK_rightAnkleOverrideBlendFactor";
        private static BehaviorSystem.EventController<float>? _rightAnkleOverrideBlendFactorEvent;

        private const string RIGHT_ANKLE_POSITION_OVERRIDE_EVENT_NAME = "avatarSDK_rightAnklePositionOverride";
        private static BehaviorSystem.EventController<Avatar2.CAPI.ovrAvatar2Vector3f>? _rightAnklePositionOverrideEvent;

        private const string RIGHT_ANKLE_ROTATION_OVERRIDE_EVENT_NAME = "avatarSDK_rightAnkleRotationOverride";
        private static BehaviorSystem.EventController<Avatar2.CAPI.ovrAvatar2Quatf>? _rightAnkleRotationOverrideEvent;

        private const string ENABLE_LOCAL_ANIMATION_PLAYBACK_EVENT_NAME = "avatarSDK_enableLocalAnimationPlayback";
        private static BehaviorSystem.EventController<bool>? _enableLocalAnimationPlaybackEvent;
        ...
        protected override void OnUserAvatarLoaded(OvrAvatarEntity entity)
        {
            ...
            if (_inputBlended)
            {
                ...
                _enableLeftAnkleOverrideEvent ??= BehaviorSystem.EventController<bool>.Register(ENABLE_LEFT_ANKLE_OVERRIDE_EVENT_NAME);
                _leftAnkleOverrideBlendFactorEvent ??= BehaviorSystem.EventController<float>.Register(LEFT_ANKLE_OVERRIDE_BLEND_FACTOR_EVENT_NAME);
                _leftAnklePositionOverrideEvent ??= BehaviorSystem.EventController<Oculus.Avatar2.CAPI.ovrAvatar2Vector3f>.Register(LEFT_ANKLE_POSITION_OVERRIDE_EVENT_NAME);
                _leftAnkleRotationOverrideEvent ??= BehaviorSystem.EventController<Oculus.Avatar2.CAPI.ovrAvatar2Quatf>.Register(LEFT_ANKLE_ROTATION_OVERRIDE_EVENT_NAME);

                _enableRightAnkleOverrideEvent ??= BehaviorSystem.EventController<bool>.Register(ENABLE_RIGHT_ANKLE_OVERRIDE_EVENT_NAME);
                _rightAnkleOverrideBlendFactorEvent ??= BehaviorSystem.EventController<float>.Register(RIGHT_ANKLE_OVERRIDE_BLEND_FACTOR_EVENT_NAME);
                _rightAnklePositionOverrideEvent ??= BehaviorSystem.EventController<Oculus.Avatar2.CAPI.ovrAvatar2Vector3f>.Register(RIGHT_ANKLE_POSITION_OVERRIDE_EVENT_NAME);
                _rightAnkleRotationOverrideEvent ??= BehaviorSystem.EventController<Oculus.Avatar2.CAPI.ovrAvatar2Quatf>.Register(RIGHT_ANKLE_ROTATION_OVERRIDE_EVENT_NAME);

                _enableLocalAnimationPlaybackEvent ??= BehaviorSystem.EventController<bool>.Register(ENABLE_LOCAL_ANIMATION_PLAYBACK_EVENT_NAME);
            }
